...
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_ABSENT_INFORMATION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_ACCESS_DENIED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_CIRCULAR_CLASS_DEFINITION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_CLASS_LOADER_UNSUPPORTED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_CLASS_NOT_PREPARED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_DUPLICATE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_FAILS_VERIFICATION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_ILLEGAL_ARGUMENT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INTERNAL;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INTERRUPT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_CLASS;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_CLASS_FORMAT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_ENVIRONMENT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_EVENT_TYPE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_FIELDID;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_LOCATION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_METHODID;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_MONITOR;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_OBJECT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_PRIORITY;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_SLOT;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_THREAD;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_THREAD_GROUP;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_INVALID_TYPESTATE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_MUST_POSSESS_CAPABILITY;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NAMES_DONT_MATCH;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NATIVE_METHOD;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NONE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NOT_AVAILABLE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NOT_FOUND;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NOT_MONITOR_OWNER;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NO_MORE_FRAMES;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_NULL_POINTER;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_OPAQUE_FRAME;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_OUT_OF_MEMORY;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_THREAD_NOT_ALIVE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_THREAD_NOT_SUSPENDED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_THREAD_SUSPENDED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_TYPE_MISMATCH;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNATTACHED_THREAD;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNMODIFIABLE_CLASS;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_CLASS_MODIFIERS_CHANGED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_HIERARCHY_CHANGED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_METHOD_ADDED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_METHOD_DELETED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_METHOD_MODIFIERS_CHANGED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_REDEFINITION_SCHEMA_CHANGED;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_UNSUPPORTED_VERSION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_ERROR_WRONG_PHASE;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_VERSION;
import static com.skiy.terminator.hooks.jvm.ti.JVMTIConstants.JVMTI_VERSION_1_2;
...
public final class JVMTI {
    ...
    private abstract static class Native {
        ...
        @LibrarySymbol(name = "GetLoadedClasses")
        @CallSignature(type = NATIVE_STATIC_OMIT_ENV, ret = INT, args = {LONG_AS_WORD, LONG_AS_WORD, LONG_AS_WORD})
        abstract int GetLoadedClasses(long env, long count_ptr, long classes_ptr);

        @LibrarySymbol(name = "Deallocate")
        @CallSignature(type = NATIVE_STATIC_OMIT_ENV, ret = INT, args = {LONG_AS_WORD, LONG_AS_WORD})
        abstract int Deallocate(long env, long mem);

        @LibrarySymbol(name = "GetClassSignature")
        @CallSignature(type = NATIVE_STATIC_OMIT_ENV, ret = INT, args = {LONG_AS_WORD, LONG_AS_WORD, LONG_AS_WORD, LONG_AS_WORD})
        abstract int GetClassSignature(long env, long klass, long signature_ptr, long generic_ptr);
    ...
    public static void Deallocate(long mem) throws JVMTIException {
        checkError(Native.INSTANCE.Deallocate(JVMTI_ENV, mem));
    }

    public static List<String> getAllLoadedClassNames() throws JVMTIException {
        try (Arena arena = Arena.ofConfined()) {
                ...
                try {
                    for (int i = 0; i < count; i++) {
                        try {
                            ...
                            // Получаем имя СРАЗУ, пока ссылка 'class_ref' еще жива.
                            // String - это обычный Java-объект, он не умрет после PopLocalFrame.
