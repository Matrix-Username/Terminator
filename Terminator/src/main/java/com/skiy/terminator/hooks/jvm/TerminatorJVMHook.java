...
import static com.skiy.terminator.hooks.jvm.Utils.rawMethodTypeOf;
...
import com.skiy.terminator.hooks.jvm.Runtime.DebugState;
...
public class TerminatorJVMHook {
    static {
    ...
    private static final String INVOKER_NAME = TerminatorJVMHook.class.getName() + "$$$Invoker";
    ...
    private static Class<?> loadInvoker(MethodType type) {
        ...
        var dexfile = DexFileUtils.openDexFile(invokers_cache.get(type, TerminatorJVMHook::generateInvoker));
